...
{
	/**
	 * Builds a plain link to the userdetails of the given user
	 *  
	 * @param int $id the user-id
	 * @param string $name the username
	 * @return string the link to the userdetails
	 */
	public static function get_link_plain($id,$name)
	{
	...
	/**
	 * returns the image-url or an error for the avatar-display in the user-details.
	 *
	 * @param int $avatar_id the id of the avatar
	 * @param int $user_id the id of the user
	 * @return string the result
	 */
	public static function get_profile_avatar_url($avatar_id,$user_id)
	{
		$locale = FWS_Props::get()->locale();

...
final class BS_Front_Module_topics extends BS_Front_Module
{
	...
	public function run()
	{
		...
		$tpl->add_variables(array(
			...
			'mark_read_url' => $forum_read_url,
			'subscr_forum_url' => $subscribe_forum_url
		));
	...
	private function _add_bottom()
	{
		...
		$tpl->add_variables(array(
			...
			// mliebgott theme
			'order_array_ins' => $order_options_array,
			'limit_array_ins' => $limit_options_array,
			'ascdesc_array_ins' => $ad_options_array
		));
	}
}
?>
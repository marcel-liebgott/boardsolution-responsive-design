...
final class BS_Front_Module_memberlist extends BS_Front_Module
{
	...
	public function run()
	{
		...
		$tpl->add_variables(array(
			...
			'name_col_custom' => $functions->get_custom_order_column(
				$locale->lang('name'),'name','ASC',$order,$orderurl,$asc,$desc
			),
			'posts_col_custom' => $functions->get_custom_order_column(
				$locale->lang('posts'),'posts','DESC',$order,$orderurl,$asc,$desc
			),
			'lastlogin_col_custom' => $functions->get_custom_order_column(
				$locale->lang('lastlogin'),'lastlogin','DESC',$order,$orderurl,$asc,$desc
			),
			'register_col_custom' => $functions->get_custom_order_column(
				$locale->lang('registeredsince'),'register','DESC',$order,$orderurl,$asc,$desc
			),
			'usergroup_col_custom' => $functions->get_custom_order_column(
				$locale->lang('group'),'user_group','ASC',$order,$orderurl,$asc,$desc
			),
			'name_col_width' => $name_col_width,
			'colspan' => $colspan,
		...
		$tpl->add_variables(array(
			...
			// mliebgott theme
			'user_group_combo_array' => $user_group_options,
			'selected_user_groups' => $selected_groups,
			'sum_user_groups' => count($user_group_options),

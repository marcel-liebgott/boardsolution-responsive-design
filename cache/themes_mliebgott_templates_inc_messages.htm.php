<?php
function FWS_TPL_themes_mliebgott_templates_inc_messages_htm($tpl,$number) {
...
EOF;
if((isset($tplvars['loginform']) && $tplvars['loginform'])) {
$html .= <<<EOF


EOF;
$html .= $tpl->parse_template("inc_login.htm",false);
$html .= <<<EOF
